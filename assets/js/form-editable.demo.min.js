...
var handleEditableFieldConstruct = function () {
    ...
    $("#meeting_start").editable({
        format: "yyyy-mm-dd hh:ii", viewformat: "dd/mm/yyyy hh:ii", validate: function (e) {
    ...
    $("#country").editable({source: t, select2: {width: 200, placeholder: "Select country", allowClear: true}});
    $("#address").editable({
        url: "/post",
