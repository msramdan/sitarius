							...
							<table id="data-table-default" class="table  table-bordered table-hover table-td-valign-middle">
								...
								<tr>
									...
									<td><select name="jenis_kelamin" class="form-control theSelect" value="<?= $jenis_kelamin ?>">
											...
											<option value="Laki Laki" <?php echo $jenis_kelamin == 'Laki Laki' ? 'selected' : 'null' ?>>Laki
												Laki</option>
											<option value="Perempuan" <?php echo $jenis_kelamin == 'Perempuan' ? 'selected' : 'null' ?>>
												Perempuan</option>
										</select>
									</td>
								</tr>
										...
										<select name="kantor_wilayah" class="form-control theSelect">
											...
											<?php foreach ($kantor_wilayah_data as $key => $data) { ?>
												<?php if ($kantor_wilayah == $data->kantor_wilayah_id) { ?>
													<option value="<?php echo $data->kantor_wilayah_id ?>" selected>
									...
									<td>
										<select name="bank_id" class="form-control theSelect">
											...
											<?php foreach ($bank as $key => $data) { ?>
												...
												<?php } else { ?>
													<option value="<?php echo $data->bank_id ?>"><?php echo $data->nama_bank ?>
													</option>
												<?php } ?>
											<?php } ?>
										</select>
