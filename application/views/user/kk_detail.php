				...
				<div class="panel-body">
						...
						<div class="col-sm-6">
							<table class="table table-bordered table-hover table-td-valign-middle">
								<tr>
									...
									<td>
										<select disabled class="form-control" name="kepala_keluarga" id="kepala_keluarga" placeholder="Kepala Keluarga">
								...
								<tr>
									<td colspan="2" style="text-align: center;">
										...
										<input readonly type="text" class="form-control" name="no_kk" id="no_kk" placeholder="No Kk" value="<?php echo $no_kk; ?>" style="font-size: 19px;font-weight: bold;height: 50px;" />
									</td>
								</tr>

								<tr>
									<td>Tgl Dikeluarkan <?php echo form_error('tgl_dikeluarkan') ?></td>
									<td> <input readonly class="form-control" type="date" name="tgl_dikeluarkan" id="tgl_dikeluarkan" placeholder="Tgl Dikeluarkan" value="<?php echo $tgl_dikeluarkan; ?>">
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="row">
						<div class="col">
							<table class="table table-bordered table-hover table-td-valign-middle">
								<tr>
									<td rowspan="3" width="50%">Alamat <?php echo form_error('alamat') ?><textarea readonly class="form-control" rows="10" name="alamat" id="alamat" placeholder="Alamat"><?php echo $alamat; ?></textarea></td>
									<td>
										Rt <?php echo form_error('rt') ?><input readonly type="number" class="form-control" name="rt" id="rt" placeholder="Rt" value="<?php echo $rt; ?>" />
									</td>
									<td>
										Rw <?php echo form_error('rw') ?><input readonly type="number" class="form-control" name="rw" id="rw" placeholder="Rw" value="<?php echo $rw; ?>">
									</td>
									<td>
										Desa/Kelurahan <?php echo form_error('desa_kelurahan') ?>
										<select disabled class="form-control" name="desa_kelurahan" id="desa_kelurahan" placeholder="Desa Kelurahan">
								...
								<tr>
									<td>
										...
										<select disabled class="form-control" name="kecamatan" id="kecamatan" placeholder="Kecamatan">
											<option value="">Harap Pilih Kabupaten/Kota</option>
										</select>
									</td>
									<td>
										Kabupaten/Kota <?php echo form_error('kabupaten_kota') ?>
										<select disabled class="form-control" name="kabupaten_kota" id="kabupaten_kota" placeholder="Kabupaten Kota">
											<option value="">Harap Pilih Provinsi</option>
										</select>
									</td>
									<td>
										Provinsi <?php echo form_error('provinsi') ?>
										<select disabled class="form-control" name="provinsi" id="provinsi" placeholder="Provinsi">
								...
								<tr>
									<td colspan="3">
										Kode Pos <?php echo form_error('kode_pos') ?><input readonly type="text" class="form-control" name="kode_pos" id="kode_pos" placeholder="Kode Pos" value="<?php echo $kode_pos; ?>" />
									</td>
								</tr>
								<tr>
									<td colspan="4">
...
<script>
	$(document).on('ready', function() {
		...
		function createElement(data) {
			...
			var html = `<tr class='item' id='${data.id_data_anggota}'>
				...
				<td style="text-align: center;">
					<input type="hidden" class="detailny" value='${s}'/><button class="btn-edit readAnggota"><i class="fa fa-eye"></i></button>
				</td>
			</tr>`
		...
		$(document).on('click', '.readAnggota', function(e) {
